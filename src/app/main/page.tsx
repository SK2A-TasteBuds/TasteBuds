        ...
        <div className="main flex flex-col overflow-hidden items-center w-full h-screen">
            <div className="store-img relative h-3/5 w-4/5  overflow-hidden">
                <div className="swipe flex ">
                    <div className="object-cover block h-full w-[20px] bg-pink1 rounded-md absolute z-10 left-[245px]"></div>
                    <div className="object-cover block h-full w-[20px] bg-pink2 rounded-md absolute z-10 left-[235px]"></div>
