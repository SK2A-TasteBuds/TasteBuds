...
function ReviewGridItem() {
  return (
    <div className="mx-auto  max-w-lg transform overflow-hidden  bg-white shadow-md duration-300 hover:scale-105 hover:shadow-lg">
      <Image
        width={400}
        height={400}
        className=" w-full max-h-80 h-full object-cover object-center"
