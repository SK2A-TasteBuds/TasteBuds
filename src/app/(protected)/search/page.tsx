...
export default function Home() {
  ...
  // 特集ページのCSS
  const bestcontainerStyle = {
    height: '223px',
    width: '52%',
    background: 'linear-gradient(90deg, #FFC7B7 0% 60%, #FFAC95 60% 80%, #FE724C 80% 100%)',
  };
  const bestcirclestyle1 = {
    width: '200px',
    height: '200px',
    borderRadius: '50%',
  ...
  const hotcontainerStyle = {
    height: '223px',
    width: '52%',
    background: 'linear-gradient(90deg, #FFFCB5 0% 60%, #FFFA77 60% 80%, #F9FE1B 80% 100%)',
  };

  const hotcirclestyle1 = {
    width: '200px',
    height: '200px',
    borderRadius: '50%',
    WebkitBorderRadius: '50%',
  ...
  return (
    <>
      ...
      {/* 特集ページ */}
        ...
        {currentSlide === 0 && (
          ...
          <div className='flex ml-2 items-center relative'>
            <button onClick={handleNextSlide} className="absolute top-24 bg-transparent">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="gray" className="w-10 h-10 bg-transparent">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
              </svg>
            </button>
            <button onClick={handleNextSlide} className=" absolute top-24 right-0 bg-transparent">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="gray" className="w-10 h-10 bg-transparent">
        ...
        {currentSlide === 1 && (
          ...
          <div className='flex ml-2 items-center relative'>
            ...
            <a href="/">
              <Image onClick={handleMain} src={FruitSandwichSvg} alt='sushi' width={175}/>
            </a>
      ...
      <form action="" className='ml-2 mt-1 mb-1'>
        <input type="text" className='border-2 border-black' placeholder="エリア検索"/>
      </form>
