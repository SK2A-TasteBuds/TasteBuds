    ...
    <div className="main flex flex-col overflow-hidden items-center w-full h-screen">
      ...
      <div className="good-bad w-full h-1/5 flex items-center mt-3">
          ...
          <div className="bad rounded-full bg-transparent object-cover w-2/6 h-2/5 justify-center items-center flex">
            <button className="flex shadow-lg px-2 py-1  bg-transparent text-lg text-white font-semibold rounded-full bg-gradient-to-t from-transparent to-blue-100" onClick={() => nextStore(showIndex+1)}>
              <Image src={thumbs_down} alt="" className="bg-transparent object-cover w-full h-full m-auto"/>
          ...
          <div className="good rounded-full bg-transparent object-cover w-2/6 h-2/5 justify-center items-center flex">
            <button className="flex shadow-lg px-2 py-1  bg-transparent text-lg text-white font-semibold rounded-full bg-gradient-to-t from-transparent to-red-100" onClick={() => nextStore(showIndex+1)}>
              <Image src={thumbs_up} alt="" className="bg-transparent object-cover w-full h-full m-auto"/>
