  ...
  return (
    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="mt-2">
          <input
            ...
            required
            className="block w-full rounded-md border bg-white/5 py-1.5 text-black shadow-sm ring-1 ring-inset ring-white/10 focus:outline-1 sm:text-sm sm:leading-6 "
          />
        </div>
      </div>
      ...
      <div className="inline-flex items-center justify-center w-full">
        ...
        <span className="absolute px-3 font-medium text-gray-900 -translate-x-1/2 g-gray-400 left-1/2">or</span>
      </div>
      <GoogleLoginBtn/>
    </div>
