                ...
                <div className='bg-slate-400 rounded-3xl ' style={overlayStyle} >
                    <div className='bg-slate-400 rounded-3xl w-full h-fu flex'>
                        ...
                        <button className='ml-9'>
                            <Image src={loupeSvg} alt="Loupe" style={{backgroundColor: '#D9D9D9',borderRadius: '40px',}}/>
                        </button>
                        <button className='ml-9'>
                            <Image src={map} alt="Map" style={{backgroundColor: '#D9D9D9',borderRadius: '40px',}}/>
                        </button>
                        <button className='ml-9'>
                            <Image src={user} alt="User" style={{backgroundColor: '#D9D9D9',borderRadius: '40px',}}/>
                        </button>
