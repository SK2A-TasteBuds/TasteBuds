...
function MainFilter() {
  ...
  console.log(keyword, budgetValue, distance);
  ...
  return (
    <div className='flex justify-end max-w-md w-full cursor-pointer' onClick={openModal}>
      <svg
        viewBox='0 0 24 24'
        fill='none'
      ...
      {isModalOpen && (
        <div className='fixed inset-0 pt-48 flex items-start justify-center z-10 bg-black bg-opacity-50'>
          <div className=' p-8 max-w-xs w-full rounded-md relative' onClick={stopPropagation}>
            ...
            <div className='flex flex-col'>
              <label htmlFor='name' className='text-stone-600 text-sm font-medium mb-2 '>
                キーワード
              </label>
              <input
                type='text'
              ...
              <div>
                ...
                <div className='flex justify-between mb-2'>
                  <label key='1' htmlFor={`distance1_step_1`} className='text-xs text-neutral-500'>
                    300m
                  </label>
                  <label key='2' htmlFor={`distance1_step_2`} className='text-xs text-neutral-500 '>
                    500m
                  </label>

                  <label key='3' htmlFor={`distance1_step_3`} className='text-xs text-neutral-500 '>
                    1Km
                  </label>
                  <label key='4' htmlFor={`distance1_step_4`} className='text-xs text-neutral-500 '>
                    2Km
                  </label>

                  <label key='5' htmlFor={`distance1_step_5`} className='text-xs text-neutral-500 '>
                    3Km
                  </label>
                </div>
              </div>
              ...
              <div className='flex gap-1'>
                <button className=' flex w-full justify-center rounded-md bg-orange-500  px-3 py-1.5 text-md font-semibold leading-6 text-white  hover:bg-orange-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-500 '>
                  検索
                </button>
              </div>
            </div>
