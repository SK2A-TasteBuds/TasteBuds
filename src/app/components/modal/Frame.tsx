...
export default async function Frame({
  ...
  const res: any = await getReviewFromId(store_id, reviewId);
  console.log('frame', store_id, reviewId);
  ...
  return (
    <>
      ...
      />
      <div className="p-2 text-base rounded-lg max-w-md md:max-w-xl w-full">
            ...
            <div className="flex gap-2 ">
              ...
              >
                <path
                  ...
                  fill={res.like ? '#2AAC7A' : '#a1a1aa'} //#a1a1aa'
                />
              </svg>
              <svg
                width="24"
